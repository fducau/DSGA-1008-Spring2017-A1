...
def generate_model(savefolder='./'):
    ...
    torch.save(Q, savefolder + 'Q_network')
    torch.save(P, savefolder + 'P_network')
    torch.save(D_cat, savefolder + 'D_cat_network')
    torch.save(D_gauss, savefolder + 'D_gauss_network')
